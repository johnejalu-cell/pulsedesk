...
const VERTICAL_HERO_IMAGES: Record<string, string> = {
  ...
  hr:           'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=1200&q=80&fit=crop',  // diverse professional team
...
const VERTICAL_CASE_STUDY_IMAGES: Record<string, string> = {
  business:     'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1200&q=80&fit=crop',  // african team boardroom meeting
  ...
  marketing:    'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=1200&q=80&fit=crop',  // marketing meeting diverse team
  hr:           'https://images.unsplash.com/photo-1565688534245-05d6b5be184a?w=1200&q=80&fit=crop',  // professional interview
