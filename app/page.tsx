    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1">Free to start — no credit card required</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
          ...
          <button onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 border border-slate-200 text-slate-700 rounded-xl py-3 hover:bg-slate-50 transition-colors mb-6 font-medium">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-slate-400 bg-white px-4">or with email</div>
          </div>
